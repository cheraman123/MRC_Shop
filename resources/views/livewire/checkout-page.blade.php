		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
					<li >
						<input wire:model="paymend_method" class="hidden peer" id="hosting-small"  required="" type="radio" value="cod" />
					...
					<li>
						<input wire:model="paymend_method" class="hidden peer" id="hosting-big"  type="radio" value="stripe">
